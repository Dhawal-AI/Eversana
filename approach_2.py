...
classifier = pickle.load(open(r'\Users\Dhawal.Singh\Downloads\finalized_model2.pkl', 'rb'))
vectorizer = pickle.load(open(r'\Users\Dhawal.Singh\Downloads\vectorizer.pkl', 'rb'))
